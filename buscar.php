<?php
	...
	$search = $_GET["search"];//Se obtiene del formulario de la pagina anterior para poder realizar la busqueda
...
<head>
	...
	<title>SAPPHIRE CARE | <?php echo $search; ?></title>
</head>
<body>
	...
	<?php
		...
		buscar($search,$idcliente);//Funcion que se encuentra en consultas.php
