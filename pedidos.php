...
<head>
	...
	<title>SAPPHIRE CARE | PEDIDOS</title>
</head>
<body>
	...
	<div class="text-center">
		<?php
			echo "<h1>Si tienes dudas con tu pedido <a href='about.php?idcliente=".$idcliente."'>contáctanos</a>.</h1>"
		?>
	</div>
	...
	<div class='container text-center' style='margin-top: 25px;'>
		<div class='row'>
			...
			<div class='card col-md-8 bg-info text-white'>
				
				<div class="card-header bg-dark" style="margin:25px;">
					<h1 class='card-title'><strong>Pedidos</strong></h1>
				</div>
				<div class="card  bg-white text-white" style='margin:25px'>

			<?php
					mostrarPedidos($idcliente);//Funcion que se encuentra en consultas.php
